...
app.get('/search', async (req, res) => {
    ...
    const addProfileData = (req, res, next) => {
      ...
      app.get('/create-account',(req,res)=>{
            res.render('./UserInfo/Create-Account')
      })
      ...
      app.post('/signup', async (req, res) => {
          ...
          app.post('/create-account', (req, res) => {
            // Handle form submission and account creation here
            // Access form data using req.body.firstName, req.body.lastName, etc.
            // Process the account creation and redirect to a success page
            // For simplicity, you can just render a success page here:
            res.render('./UserInfo/Create-Account', {
