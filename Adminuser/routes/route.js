...
app.get('/search', async (req, res) => {
    ...
    const addProfileData = (req, res, next) => {
      ...
      //       const apiUrl="http://api.ne5.money/nee5/UserAPI/user_registration"
      //       const options = {
      //             headers: {
      ...
      //           },options)
      //           .then((response) => {
      //             console.log("Success full Response is : ",response);
      //           }, (error) => {
      //             console.log("Error : ",error);
      //           });
      // app.get("/demapi", function(req,res){
      //             axios.post('https://api.ne5.money/nee5/UserAPI/user_registration', {
      //                 name: 'Fred',
      //                 password: 'Flintstone'
      //               },{
      //                 headers: {
      ...
      app.post('/registration', async (req, res) => {
        ...
        try {
          ...
          console.log("Successful Response is : ", response.data);
